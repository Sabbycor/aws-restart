...
- **Tools**: VS Code, Linux (WSL), Git

## 🚀 Obiettivo
Imparare i fondamenti del Cloud Computing e ottenere la certificazione AWS Cloud Practitioner e AWS Architecting.

## 👨‍🏫 Team Formatori
Il percorso è guidato da professionisti del settore:
- **Emanuele Gurini**: Moduli tecnici (Python, Django, AWS, Linux, AI Tools).
- **Paola Lombardi**: Project Management & Soft Skills, AI Tools.
